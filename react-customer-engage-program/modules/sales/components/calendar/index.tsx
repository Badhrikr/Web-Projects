...
import { GetCalendarResponse } from "../../services/model.response";

const localizer = momentLocalizer(moment);

function CalendarContainer() {
  const [fetching, setFetching] = useState(true);
  const [calendar, setCalendar] = useState<GetCalendarResponse[]>([]);
  ...
  const fetchSuccess = (response: GetCalendarResponse[]) => {
    setFetching(false);
