...
import { DisqualifyCustomerProps } from "./model";
...
function DisqualifyCustomer({ customerId }: DisqualifyCustomerProps) {
...
export default DisqualifyCustomer;
