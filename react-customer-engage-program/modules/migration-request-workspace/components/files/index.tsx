...
import { FileUploadType, NormalFileUploadType } from "../../enums";
...
function FilesContainer({
  ...
  useEffect(() => {
    ...
    Services.GetFilesForMigrationRequest({
      migrationRequestId,
  ...
  return (
    <div className="px-4 flex flex-col gap-4">
      <h3 className="font-semibold text-theme-secondary text-xl">Documents</h3>
      ...
      <Modal isOpen={showFileUpload} close={uploadFileToggle}>
        <div className="pt-14 pb-4 px-4">
          <FileUpload
            ...
            uploadTypes={NormalFileUploadType}
